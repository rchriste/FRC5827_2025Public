...
import frc.robot.util.SmartOdometry;
...
public class Drive extends SubsystemBase {
    ...
    private static final double ROBOT_MOI = 2.317;
    ...
    private final SwerveSetpointGenerator setpointGenerator =
            new SwerveSetpointGenerator(
                    PP_CONFIG,
                    Units.rotationsToRadians(100.0 / TunerConstants.FrontLeft.SteerMotorGearRatio));
    private final Transform2d trajectoryTransform = new Transform2d(-1.0, 0, Rotation2d.kZero);
    ...
    private PoseEstimator<SwerveModulePosition[]> poseEstimator =
            new PoseEstimator<>(
                    kinematics,
                    new SmartOdometry<>(
    ...
    public void periodic() {
        ...
        Logger.recordOutput("Drive/LookaheadPose", getPoseLookahead(0.1));
        ...
        Logger.recordOutput("PeriodicTime/Drive", (Timer.getFPGATimestamp() - startTime) * 1000);
    }
    ...
    public void runVelocity(ChassisSpeeds speeds) {
        ...
        Logger.recordOutput("SwerveChassisSpeeds/Setpoints", currentSetpoint.robotRelativeSpeeds());
    ...
    public Command goToPoint(Pose2d target) {
        Pose2d startingPose = target.transformBy(trajectoryTransform);
        var path =
                new PathPlannerPath(
    ...
    @AutoLogOutput(key = "Drive/AccelMagnitude")
    public double getAccelerationMagnitude() {
        return Math.hypot(
                gyroInputs.xAccelMetersPerSecSquared, gyroInputs.yAccelMetersPerSecSquared);
    }
    ...
    public Pose2d getPoseLookahead(double lookaheadTime) {
        ...
        return getPose()
                .transformBy(
                        new Transform2d(
                                        ...
                                        Rotation2d.fromRadians(currentSpeeds.omegaRadiansPerSecond))
                                .times(lookaheadTime));
    }
