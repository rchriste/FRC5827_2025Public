...
/** WPILib PID Controller with velocity setpoints. */
public class PIDController implements Sendable, AutoCloseable {
    ...
    private double m_derivativeSetpoint;
    ...
    public void setSetpoint(double setpoint, double derivativeSetpoint) {
        m_setpoint = setpoint;
        m_derivativeSetpoint = derivativeSetpoint;
        m_haveSetpoint = true;
    ...
    /**
     * Returns the derivative setpoint of the PIDController.
     *
     * @return The derivative setpoint.
     */
    public double getDerivativeSetpoint() {
        return m_derivativeSetpoint;
    }
    ...
    public double calculate(double measurement, double setpoint) {
        return calculate(measurement, setpoint, 0.0);
    }
     ...
     *
     * @param measurement The current measurement of the process variable.
     * @param setpoint The new position setpoint of the controller.
     * @param derivativeSetpoint The new derivative setpoint of the controller.
     * @return The next controller output.
     */
    public double calculate(double measurement, double setpoint, double derivativeSetpoint) {
        m_setpoint = setpoint;
        m_derivativeSetpoint = derivativeSetpoint;
        m_haveSetpoint = true;
    ...
    public double calculate(double measurement) {
        ...
        m_errorDerivative = (m_error - m_prevError) / m_period + m_derivativeSetpoint;
